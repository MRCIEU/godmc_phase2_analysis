...
```{r}
x1 <- data_frame(r2=r2, power_overall=pwr.chisq.test(w=sqrt(r2),N=28000,df=1,sig.level=1e-10)$power, missed_overall = 1 - power_overall, cist="cis", what="phase2")
x2 <- data_frame(r2=r2, power_overall=pwr.chisq.test(w=sqrt(r2),N=28000,df=1,sig.level=1e-14)$power, missed_overall = 1 - power_overall, cist="trans", what="phase2")
```
