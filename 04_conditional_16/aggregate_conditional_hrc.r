...
{
	message(i)
	fn <- paste0("../results_hrc/16_hrc/16_", i, "_conditional_cis.rdata")
	if(file.exists(fn))
	{
		load(fn)
		l[[i]] <- clumped
...
{
	message(i)
	fn <- paste0("../results_hrc/16_hrc/16_", i, "_conditional_trans.rdata")
	if(file.exists(fn))
	{
		load(fn)
		l[[i]] <- clumped
...
save(conditional.cis, file="../results_hrc/16_hrc/16_conditional_hrc_cis.rdata")
save(conditional.trans, file="../results_hrc/16_hrc/16_conditional_hrc_trans.rdata")
