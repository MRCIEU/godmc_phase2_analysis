...
ANNOTDIR=/mnt/data1/goDMC_Phase2/godmc_phase2_analysis/09_garfield/annotationCisTrans
...
OUTDIR=/mnt/data1/goDMC_Phase2/godmc_phase2_analysis/09_garfield/resultsCisTrans/$INPUTNAME
mkdir -p $OUTDIR
