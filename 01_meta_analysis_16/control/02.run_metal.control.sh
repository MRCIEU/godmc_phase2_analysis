...
cohort_dir="../data/16/"
metal_dir="../scratch/control/16_${i}"
result_dir="../results/16/control"
...
#CHR MARKERNAME EA MODEL N SE BETA P
...
#	rm -r ${cohortname}_${i}
#
	echo "PROCESS /panfs/panasas01/shared-godmc/godmc_phase2_analysis/scratch/control/${cohortname}.control.merged" >> ${metal_dir}/${metal_in}

done

echo "" >> ${metal_dir}/${metal_in}
#echo "ANALYZE RANDOM" >> ${metal_dir}/${metal_in}
echo "ANALYZE" >> ${metal_dir}/${metal_in}
