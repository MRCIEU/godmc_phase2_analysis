...
p1<-ggplot(ps %>% subset(., !grepl("6:", variant)), aes(x = b.x, y = b.y)) +
geom_point(aes(colour=fdr.y < 0.05)) +
geom_smooth(method="lm") +
theme_bw() +
labs(x="Primary causal estimate", y="Secondary causal estimate", colour="Secondary\nFDR < 0.05")
ggsave(plot=p1,file="/mnt/storage/home/epzjlm/scratch/repo/godmc_phase2_analysis/images/mr_cellcounts.jpg", height=7, width=7,device = function(...) jpeg(...,units="in",res=1200))
ggsave(plot=p1,file="/mnt/storage/home/epzjlm/scratch/repo/godmc_phase2_analysis/images/mr_cellcounts.pdf", height=7, width=7,units="in",dpi=1200)
